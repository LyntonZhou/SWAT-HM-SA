...
ihml=max(par_f(strcmp(symbol, 'HM_NUM'))==1 || ...
    par_f(strcmp(symbol, 'HML_AREA_FRA'))==1 || ...
...
if ihml==1;
    for hru_no=1:n_hru;
        hruid=file_id(hru_no, 3);
        hru_lnd=upper(file_id{hru_no, 6});
        chm(hruid, hru_lnd, par_n, par_f, symbol, x, alter_m, lba, uba, sensin_path, out_data_path);
    end
