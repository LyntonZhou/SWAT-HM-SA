...
ires  = max(par_f(strcmp(symbol, 'RES_K'))==1 || ...
    par_f(strcmp(symbol, 'RES_RR'))==1 || ...
    par_f(strcmp(symbol, 'WURTNF'))==1 || ...
    par_f(strcmp(symbol, 'EVRSV'))==1 || ...
    par_f(strcmp(symbol, 'OFLOWMN_FPS'))==1 || ...
    par_f(strcmp(symbol, 'STARG_FPS'))==1);

imetal  = max(par_f(strcmp(symbol, 'METAL_KD1'))==1 || ...
    par_f(strcmp(symbol, 'METAL_KD2'))==1 || ...
    par_f(strcmp(symbol, 'METAL_KD3'))==1 || ...
    par_f(strcmp(symbol, 'METAL_KS1'))==1 || ...
    par_f(strcmp(symbol, 'METAL_KS2'))==1 || ...
    par_f(strcmp(symbol, 'METAL_KW'))==1 || ...
    par_f(strcmp(symbol, 'METAL_KU'))==1);

% change parameters in the input files
if ibsn==1;
    bsn(par_n, par_f, symbol, x, alter_m, lba, uba, sensin_path, out_data_path);
    disp([num2str(sum(par_f(strcmp(Inpf, '.bsn')))) ' parameters in .bsn modeified'])
end

if iwwq==1;
    wwq(par_n, par_f, symbol, x, alter_m, lba, uba, sensin_path, out_data_path);
    disp([num2str(sum(par_f(strcmp(Inpf, '.wwq')))) ' parameters in .wwq modeified'])
end

if icrop==1;
    crop(symbol, x, sensin_path, out_data_path);
    disp([num2str(sum(par_f(strcmp(Inpf, 'crop.dat')))) ' parameters in crop.dat modeified'])
end

if ipest==1;
    pest(symbol, x, sensin_path, out_data_path);
    disp([num2str(sum(par_f(strcmp(Inpf, 'pest.dat')))) ' parameters in pest.dat modeified'])
end

% parameters in metal.dat
if imetal==1;
    metal(par_f, symbol, x, alter_m, lba, uba, sensin_path, out_data_path);
    disp([num2str(sum(par_f(strcmp(Inpf, 'metal.dat')))) ' parameters in metal.dat modeified'])
end
...
iswq=max(par_f(strcmp(symbol, 'RS1'))==1 || ...
    ...
    par_f(strcmp(symbol, 'CH_HM_STL'))==1 || ...
    par_f(strcmp(symbol, 'CH_HM_RSP'))==1 || ...
    par_f(strcmp(symbol, 'CH_HM_MIX'))==1 || ...
    par_f(strcmp(symbol, 'CH_HM_BRY'))==1 || ...
    par_f(strcmp(symbol, 'CH_HM_LABCONC'))==1 || ...
    par_f(strcmp(symbol, 'CH_HM_NONLABCONC'))==1 || ...
    par_f(strcmp(symbol, 'CH_HM_ACT'))==1);
...
if isub==1;
    ...
    disp([num2str(sum(par_f(strcmp(Inpf, '.sub')))) ' parameters in .sub modeified'])
end
...
if irte==1;
    ...
    disp([num2str(sum(par_f(strcmp(Inpf, '.rte')))) ' parameters in .rte modeified'])
end
...
if iswq==1;
    ...
    disp([num2str(sum(par_f(strcmp(Inpf, '.swq')))) ' parameters in .swq modeified'])
end
...
if ilwq==1;
    ...
    disp([num2str(sum(par_f(strcmp(Inpf, '.lwq')))) ' parameters in .lwq modeified'])
end
...
if ires==1;
    ...
    disp([num2str(sum(par_f(strcmp(Inpf, '.res')))) ' parameters in .res modeified'])
end
...
% parameters for SWAT-HM
ihml=max(par_f(strcmp(symbol, 'HML_AREA_FRA'))==1 || ...
    par_f(strcmp(symbol, 'HML_ROCK'))==1 || ...
    par_f(strcmp(symbol, 'SOL_HM_LABCONC'))==1 || ...
    par_f(strcmp(symbol, 'SOL_HM_NONLABCONC'))==1 || ...
    par_f(strcmp(symbol, 'HM_ENR'))==1 || ...
    par_f(strcmp(symbol, 'HM_AGR'))==1 || ...
    par_f(strcmp(symbol, 'HM_AGR_FRA'))==1 || ...
    par_f(strcmp(symbol, 'HM_ATMO'))==1 || ...
    par_f(strcmp(symbol, 'HM_ATMO_FRA'))==1);
...
if imgt==1;
    ...
    disp([num2str(sum(par_f(strcmp(Inpf, '.mgt')))) ' parameters in .mgt modeified'])
end
...
if ihru==1;
    ...
    disp([num2str(sum(par_f(strcmp(Inpf, '.hru')))) ' parameters in .hru modeified'])
end
...
if isol==1;
    ...
    disp([num2str(sum(par_f(strcmp(Inpf, '.sol')))) ' parameters in .sol modeified'])
end
...
if igw==1;
    ...
    disp([num2str(sum(par_f(strcmp(Inpf, '.gw')))) ' parameters in .gw modeified'])
end
...
if ichm==1;
    ...
    disp([num2str(sum(par_f(strcmp(Inpf, '.chm')))) ' parameters in .chm modeified'])
end
...
if ihml==1;
    for hru_no=1:n_hru;
        hruid=file_id(hru_no, 3);
        hru_lnd=upper(file_id{hru_no, 6});
        hml(hruid, hru_lnd, par_n, par_f, symbol, x, alter_m, lba, uba, sensin_path, out_data_path);
    end
    disp([num2str(sum(par_f(strcmp(Inpf, '.hml')))) ' parameters in .hml modeified'])
end
