...
function [swat_out]=read_output(out,outlet,IPRINT,w_errors,ICALIB, n_DayinMonth, n_DayinYear, NBYR, nOutlets)
%% This cell should be coordinated with the cio m-file
out_id=w_errors; out_id(w_errors(:)~=0)=1;
...
for i=1:length(index)
    ...
    elseif index(i)== 2 % Sediment
        ...
        else % Sediment outputs in mg/l (ppm) [average daily]
